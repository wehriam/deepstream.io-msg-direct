...
describe( 'Messages are send between multiple instances', function(){
	...
	it( 'creates connectorA', function( done ){
		...
		connectorA.on( 'error', function( e ){console.log( 'ERROR', e ); throw e; });
	});
	...
	it( 'creates connectorB', function( done ){
		...
		connectorB.on( 'error', function( e ){console.log( 'ERROR', e ); throw e; });
	});
	...
	it( 'creates connectorC', function( done ){
		...
		connectorC.on( 'error', function( e ){console.log( 'ERROR', e ); throw e; });
	});
